...
"Transl8 &😊",
                          ...
                          Text(
                            "Don't let language barriers stop you. Translate seamlessly with our app, supporting real-time translations between English and Chichewa. Explore features like text input, voice translation, and saved phrases to enhance your communication.",
                            style: TextStyle(
                  ...
                  const SizedBox(height: 16),
                  Text(
                    "Elevate your experience today with our language translator",
                    style: TextStyle(
                        color: Colors.black.withOpacity(0.7),
                        fontFamily: "Inter",
                        fontSize: 13),
